...
import ro.webdata.echo.translator.edm.lido.mapping.core.administrativeMetadata.RecordWrapProcessing.CimecProvider;
        ...
        if (size > 0) {
            ...
            if (recordSourceType.equals(LIDOType.EUROPEANA_DATA_PROVIDER)) {
                ...
                if (providerName == null) {
                    ...
                    String uri = URIUtils.prepareUri(NS_REPO_RESOURCE_ORGANIZATION, Text.sanitizeString(providerName, true));
                    dataProvider = model
                            .createResource(uri)
