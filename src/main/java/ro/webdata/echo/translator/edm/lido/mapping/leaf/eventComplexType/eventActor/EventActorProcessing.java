package ro.webdata.echo.translator.edm.lido.mapping.leaf.eventComplexType.eventActor;
...
public class EventActorProcessing {
    ...
    private static Resource generateActorName(Model model, AppellationValue appellationValue, ArrayList<RoleActor> roleActorList) {
        ...
        if (actorName != null) {
            ...
            String uri = URIUtils.prepareUri(NS_REPO_RESOURCE_AGENT, Text.sanitizeString(actorName, true));
