package ro.webdata.echo.translator.edm.dspace;
...
import ro.webdata.echo.translator.edm.dspace.commons.ProvidedCHO;
import ro.webdata.echo.translator.edm.dspace.mapping.core.dc.DcMapping;
import ro.webdata.echo.translator.edm.dspace.mapping.core.europeana.EuropeanaMapping;
...
public class DSpaceTranslator {
    public static void run() {
        Model model = GraphModel.generateModel();
        mapEntries(model, FileConst.PATH_INPUT_DSPACE_DIR);
