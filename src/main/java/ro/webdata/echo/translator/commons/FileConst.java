...
public class FileConst {
    ...
    public static final String PATH_UNIQUE_MISSING_COUNTRY_REGION = PATH_OUTPUT_LIDO_DIR + File.FILE_SEPARATOR + "missing_country_and_region_unique" + File.EXTENSION_SEPARATOR + File.EXTENSION_CSV;
