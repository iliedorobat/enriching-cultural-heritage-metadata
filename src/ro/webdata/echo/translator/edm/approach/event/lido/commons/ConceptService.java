...
public class ConceptService {
    ...
    public static void add(String concept) {
        String camelCaseConcept = Text.toCamelCase(concept, true, DELIMITERS);
        String uri = prepareConceptUri(concept);
        HttpResponse<String> response = SyncHttpClient.callApi(uri);
        ...
        if (conceptsMap.get(camelCaseConcept) == null) {
            ...
            switch (statusCode) {
                case HttpURLConnection.HTTP_OK:
                    ...
                    conceptsMap.put(camelCaseConcept, uri);
                    break;
                ...
                case HttpURLConnection.HTTP_SEE_OTHER:
                    ...
                    location.ifPresent(newLink -> conceptsMap.put(camelCaseConcept, newLink));
                    break;
                default:
                    break;
            }
    ...
    private static String prepareConceptUri(String concept) {
