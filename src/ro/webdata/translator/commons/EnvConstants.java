...
public final class EnvConstants {
    ...
    public static final String NS_REPO_PROPERTY = Namespace.NS_REPO_PROPERTY;
    public static final String NS_REPO_RESOURCE = Namespace.NS_REPO_RESOURCE;

    public static final String NS_REPO_RESOURCE_AGENT = Namespace.NS_REPO_RESOURCE_AGENT;
    public static final String NS_REPO_RESOURCE_AGGREGATION = Namespace.NS_REPO_RESOURCE_AGGREGATION;
    public static final String NS_REPO_RESOURCE_CHO = Namespace.NS_REPO_RESOURCE_CHO;
