...
public class Constants {
     ...
     * TODO: change the second language if you need
     */
    public static final String LANG_MAIN = LANG_RO;

    public static final String CIMEC_LINK_RO = "http://ghidulmuzeelor.cimec.ro/muzeeen.asp?ctext=";
    public static final String CIMEC_LINK_EN = "http://ghidulmuzeelor.cimec.ro/muzee.asp?ctext=";
